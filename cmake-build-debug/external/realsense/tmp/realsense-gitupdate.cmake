...
execute_process(
  COMMAND "/usr/bin/git" show-ref v2.17.0
  WORKING_DIRECTORY "/home/andrep/workspace/forks/FAST/cmake-build-debug/external/realsense/src/realsense"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.17.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.17.0")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v2.17.0
  WORKING_DIRECTORY "/home/andrep/workspace/forks/FAST/cmake-build-debug/external/realsense/src/realsense"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/IntelRealSense/librealsense.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/andrep/workspace/forks/FAST/cmake-build-debug/external/realsense/src/realsense/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/andrep/workspace/forks/FAST/cmake-build-debug/external/realsense/src/realsense/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
