...
SurfaceExtraction::SurfaceExtraction() {
	...
	createOpenCLProgram("/Algorithms/SurfaceExtraction/SurfaceExtraction.cl");
	createOpenCLProgram("/Algorithms/SurfaceExtraction/SurfaceExtraction_no_3d_write.cl", "no_3d_write");
}
