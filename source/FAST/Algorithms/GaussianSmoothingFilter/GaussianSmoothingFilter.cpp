...
GaussianSmoothingFilter::GaussianSmoothingFilter() {
	...
	createOpenCLProgram("Algorithms/GaussianSmoothingFilter/GaussianSmoothingFilter2D.cl", "2D");
	createOpenCLProgram("Algorithms/GaussianSmoothingFilter/GaussianSmoothingFilter3D.cl", "3D");
    mStdDev = 0.5f;
    mMaskSize = -1;
    mIsModified = true;
    mRecreateMask = true;
