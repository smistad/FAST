...
class FAST_EXPORT DualViewWindow : public Window {
    ...
    public:
        ...
        std::shared_ptr<DualViewWindow> connect(QWidget* widget, WidgetPosition position = WidgetPosition::BOTTOM);
        std::shared_ptr<DualViewWindow> connect(std::vector<QWidget*> widgets, WidgetPosition position = WidgetPosition::BOTTOM);
