...
if(APPLE)
execute_process(COMMAND MACOSX_DEPLOYMENT_TARGET=10.13 ${PYTHON_EXECUTABLE} setup.py bdist_wheel --py-limited-api cp36 WORKING_DIRECTORY "${FAST_BINARY_DIR}/python/")
else()
