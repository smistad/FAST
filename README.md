...
### Get started
See installation instructions for [Windows](https://fast.eriksmistad.no/install-windows.html), [Ubuntu Linux](https://fast.eriksmistad.no/install-ubuntu-linux.html), [Mac OS](https://fast.eriksmistad.no/install-mac.html) and [Python](https://fast.eriksmistad.no/install-python.html).
...
* [Mac OS](https://fast.eriksmistad.no/building-on-mac.html) 
